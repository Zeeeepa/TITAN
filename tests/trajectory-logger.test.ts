...
describe('AutoSkillGen', () => {
    describe('shouldGenerateSkill', () => {
        ...
        it('returns false when skill already exists', () => {
            for (let i = 0; i < 3; i++) {
                logTrajectory(makeTrajectory());
            }
            // Generate the skill first
            saveGeneratedSkill(makeTrajectory());
    ...
    describe('generateSkillContent', () => {
        it('produces valid SKILL.md with frontmatter', () => {
            const content = generateSkillContent(makeTrajectory());
    ...
    describe('saveGeneratedSkill', () => {
        it('creates SKILL.md in workspace skills directory', () => {
            const skill = saveGeneratedSkill(makeTrajectory());
    ...
    describe('findMatchingSkills', () => {
        it('finds auto-generated skills by task type', () => {
            saveGeneratedSkill(makeTrajectory());
    ...
    describe('getSkillGuidance', () => {
        it('returns guidance string when matching skill exists', () => {
            saveGeneratedSkill(makeTrajectory());
    ...
    describe('processTrajectoryForSkills', () => {
        it('generates skill when threshold is met', () => {
            for (let i = 0; i < 3; i++) {
                logTrajectory(makeTrajectory());
            }
