        ...
        <div>
          ...
          <div className="space-y-1">
            {wisdom.patterns.slice(0, 8).map((p, i) => (
              <div key={i} className="flex items-center justify-between px-2 py-1.5 rounded bg-white/[0.02] text-[11px]">
        ...
        <div>
          ...
          <div className="space-y-1">
            {wisdom.mistakes.slice(-5).map((m, i) => (
              <div key={i} className="px-2 py-1.5 rounded bg-white/[0.02] text-[11px] text-text-muted">
